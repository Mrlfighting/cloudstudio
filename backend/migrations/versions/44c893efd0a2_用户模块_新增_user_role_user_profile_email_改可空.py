"""用户模块：新增 user_role/user_profile，email 改可空

Revision ID: 44c893efd0a2
Revises: 
Create Date: 2026-08-12 17:36:28.113768
...
def upgrade() -> None:
    ...
    sa.Column('user_profile', sa.String(length=512), nullable=True),
