  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'spaces/team',
          name: 'team-space-list',
          component: () => import('@/views/teamSpace/TeamSpaceListView.vue'),
          meta: { title: '团队空间', requiresAuth: true },
        },
        {
          path: 'spaces/team/create',
          name: 'team-space-create',
          component: () => import('@/views/teamSpace/TeamSpaceCreateView.vue'),
          meta: { title: '创建团队空间', requiresAuth: true },
        },
        {
          path: 'spaces/team/:id',
          name: 'team-space-detail',
          component: () => import('@/views/teamSpace/TeamSpaceDetailView.vue'),
          meta: { title: '团队空间', requiresAuth: true },
        },
        {
          path: 'spaces/team/:id/pictures/:pictureId',
          name: 'team-space-picture-detail',
